          ...
          {courses.map((c, i) => (
            <AnimatedSection key={c.id} delay={i * 0.1}>
              <GlassCard className="flex flex-col h-full">
                <div className="w-full h-36 sm:h-44 rounded-2xl bg-gradient-to-br from-blue-500/20 to-brand-500/20 flex items-center justify-center mb-4">
                  <BookOpen size={40} className="text-brand-400 sm:hidden" />
                  <BookOpen size={48} className="text-brand-400 hidden sm:block" />
                </div>
                ...
                <div className="flex items-center justify-between mt-4 sm:mt-6">
                  ...
                  <Link href="/contact">
                    <Button size="sm" className="sm:hidden">Enroll</Button>
                    <Button className="hidden sm:inline-flex">Enroll Now</Button>
                  </Link>
                </div>
              </GlassCard>
            </AnimatedSection>
